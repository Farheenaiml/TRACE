  ...
  return (
    <div className="surface flex flex-col items-center px-6 py-14 text-center">
      ...
      <p className="mt-2 max-w-md text-sm leading-6 text-muted-foreground">
        TRACE reads commits, pull requests, issues and decision records to reconstruct the reasoning
        behind your codebase. Ask a question above to see an evidence-grounded answer.
      </p>
    </div>
  );
}
